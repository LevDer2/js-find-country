...
function renderCountry(array) {
    ...
    if (array.length > 10) return (0, _pnotifyJs.error)({
        title: "Oh No!",
        text: "Too many matches found. Please enter your a more specific query!"
    });
    else if (array.message == "Not Found") return (0, _pnotifyJs.error)({
        title: "Oh No!",
        ...
        const countrie = array.map(({ name, capital, population, flags, languages })=>{
                ...
                <div class="app-info">
                    ...
                    <h3 class="app-subtitle">Languages:
                        <ul class="app-clanguages">
                           ${languagesArray.map((language)=>`<li class="languages-item">
...
},{"../node_modules/@pnotify/core/dist/PNotify.js":"fay4s","../node_modules/@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/BrightTheme.css":"grIyt","./fetchCountries.js":"bCGdT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"grIyt":[function() {},{}],"bCGdT":[function(require,module,exports,__globalThis) {
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequirebcbc", {})

//# sourceMappingURL=js-find-country.0f77c784.js.map
